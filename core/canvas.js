...
(function (Loira) {
    ...
    var Canvas = (function () {
        ...
        function Canvas(canvas) {
             ...
             */
            this.fall = function (evt, callback) {
             ...
             */
            this._emit = function (evt, options) {
                if (typeof this._callbacks[evt] !== 'undefined') {
             ...
             */
            this.setBackground = function (image, resizeToImage) {
             ...
             */
            this.setScrollContainer = function (container) {
                var _this = this;
             ...
             * @returns {Array}
             */
            this.getRelationsFromObject = function (object, onlyIncoming, onlyOutgoing) {
                var relations = [];
